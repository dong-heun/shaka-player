...
shaka.device.IDevice = class {
  ...
  /**
   * Sets platform-specific mediaOption on video element based on manifest.
   *
   * This is primarily used for WebOS TV to provide resolution and frame rate
   * hints to the platform before MediaSource creation. The hints enable
   * optimal resource allocation and prevent unnecessary cleanup of in-use
